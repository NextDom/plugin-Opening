...
sendVarToJS('eqType', 'Opening');
$eqLogics = eqLogic::byType('Opening');
?>
<div class="row row-overflow Openingconfig">
	<div class="col-lg-2 col-md-3 col-sm-4">
		<div class="bs-sidebar">
			<ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
				<a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter Ouverture}}</a>
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 10px;">
	...
	<div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 10px;display: none;">
						...
						<fieldset data-layer="batt">
							...
							<div class="modeBatVisible">
								...
								<div class="form-group">
									...
									<i class="icon fa fa-question-circle" style="margin-top:20px" data-placement="left" data-toggle="popover" data-trigger="hover" data-animation=true data-delay=200 data-html=true 
